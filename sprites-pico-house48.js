(function () {
  ...
  var names = ['whisp', 'whisk', 'nimbrix', 'rime', 'kryz', 'glacorn', 'sprout', 'sprig', 'verdant', 'flick', 'drakember', 'infernyx', 'cephy', 'cephling', 'abyssal', 'zap', 'spark', 'storm', 'wick', 'lampkin', 'festoon', 'peep', 'ruffle', 'galebeak', 'bombshell', 'blot', 'quill', 'codex'];
