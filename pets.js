// pets.js — Pico PNG sprite overrides. Loads last so draw* replace canvas blobs.
...
(function () {
    ...
    console.log('[pets.js] Pico PNG overrides ready (20 draw* functions, data-URL packs)');
    ...
    console.log('[pets.js] electric line Zap → Spark → Storm (bolt art kept, not in chain)');
