...
(function () {
    ...
    // Edge flood-fill only: clear background connected to the canvas border.
    // Never punch interior outline blacks (that chewed sprites / left fringe).
    ...
    console.log('[pets.js] Pico PNG overrides ready; edge flood-fill chroma; 3 stages; NN upscale; hatch one line');
})();
